...
function ContentBlockItem({ block, textIndex }: ContentBlockProps) {
...
export default function ContentBlocks({ content }: ContentBlocksProps) {
    ...
    <div className={contentListCss}>
      {content.map((block, i) => {
        ...
        return (
          ...
          >
            <ContentBlockItem block={b} textIndex={textCount} />
          </motion.div>
        );
      })}
    </div>
